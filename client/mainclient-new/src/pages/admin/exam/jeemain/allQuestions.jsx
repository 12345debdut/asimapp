...
import QuestionsJee from "./Questions";
...
export default function AllJeemainQuestions() {
      ...
      <div>
        ...
        <div>
          ...
          <TabPanel value={value} index={0}>
            <QuestionsJee examcatagory={"11joint"} />
          </TabPanel>
          <TabPanel value={value} index={1}>
            <QuestionsJee examcatagory={"12joint"} />
          </TabPanel>
          <TabPanel value={value} index={2}>
            <QuestionsJee examcatagory={"11and12joint"} />
          </TabPanel>
        </div>
      </div>
    );
